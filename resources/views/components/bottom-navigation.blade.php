...
<div class="fixed bottom-0 left-0 right-0 bg-white shadow-lg border-t md:hidden z-10">
    <div class="flex justify-around">
        ...
        <a href="{{ route('vehicles.create') }}" class="flex flex-col items-center py-2 px-3 {{ request()->routeIs('vehicles.create') ? 'text-teal-500' : 'text-gray-600' }}">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <a href="{{ route('messages.index') }}" class="flex flex-col items-center py-2 px-3 {{ request()->routeIs('messages.*') ? 'text-teal-500' : 'text-gray-600' }}">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <a href="{{ route('profile.edit') }}" class="flex flex-col items-center py-2 px-3 {{ request()->routeIs('profile.*') ? 'text-teal-500' : 'text-gray-600' }}">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
