...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-3xl font-bold text-drive-teal">Modifier l'utilisateur</h1>
    </div>
        ...
        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center space-x-6">
                    <div class="flex items-center">
                        <input type="radio" name="user_type" id="user_type_particulier" value="particulier" {{ old('user_type', $user->user_type) === 'particulier' ? 'checked' : '' }} 
                    ...
                    <div class="flex items-center">
                        <input type="radio" name="user_type" id="user_type_entreprise" value="entreprise" {{ old('user_type', $user->user_type) === 'entreprise' ? 'checked' : '' }} 
                            class="h-4 w-4 text-drive-teal focus:ring-drive-teal border-gray-300">
            ...
            <div id="seller_section" class="mb-6" {{ $user->user_type === 'entreprise' ? 'style="display: none;"' : '' }}>
                <div class="flex items-center">
                    <input type="checkbox" name="is_seller" id="is_seller" value="1" {{ old('is_seller', $user->is_seller) ? 'checked' : '' }} 
                        class="h-4 w-4 text-drive-teal focus:ring-drive-teal border-gray-300 rounded">
