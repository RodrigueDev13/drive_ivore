                        ...
                        <div class="p-4 flex items-start">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex justify-between items-start">
                                    <h3 class="text-lg font-medium {{ isset($item['unread_count']) && $item['unread_count'] > 0 ? 'text-teal-600 font-bold' : 'text-gray-900' }}">
                                        {{ $item['user']->name }}
                                    </h3>
                                ...
                                @if($item['conversation']->vehicle_id && isset($item['conversation']->vehicle))
                                    <div class="mt-1 text-xs text-teal-600">
                                        À propos de: {{ $item['conversation']->vehicle->title ?? 'Véhicule non disponible' }}
                                    </div>
                                @endif
                            </div>
                        </div>
